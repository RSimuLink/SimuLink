; Inno Setup script for Roche LIT.
;
...
;
; Build with: ISCC.exe RocheLIT.iss /DPublishDir=<path> /DAppVersion=<ver>
; The build-installer.ps1 script wires these up automatically.
  ...
  #define PublishDir "..\src\RocheLIT.App\bin\Release\net10.0-windows\win-x64\publish"
#endif
...
#define AppName "Roche LIT"
#define AppExe "RocheLIT.App.exe"
...
OutputDir=output
OutputBaseFilename=RocheLIT-Setup-{#AppVersion}
...
; contains RocheLIT.App.exe, the .NET runtime, and HIMv2_1.pdf (copied
