...
namespace RocheLIT.Core.Tests.Transport;

public class MllpRoundTripTests
{
    private const string Order =
        "MSH|^~\\&|LIS|Hospital|LIT|Roche|20260624120000||OML^O33|CTRL-42|P|2.5.1\r" +
    ...
    public async Task Listener_UsesCustomAcknowledgementFromHandler()
    {
        ...
        listener.MessageReceived += (_, e) =>
            e.Acknowledgement = "MSH|^~\\&|LIT|Roche|LIS|H|20260624120000||ACK|X|P|2.5.1\rMSA|AR|CTRL-42";
        listener.Start();
