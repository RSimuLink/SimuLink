...
namespace RocheLIT.Him
{
    ...
    /// simulator's <see cref="LitSettings"/>, replacing the test, sample
    ...
    public static class HimSettingsImporter
    {
        ...
        /// </summary>
        public static HimImportSummary Apply(LitSettings settings, HostInterfaceManual manual)
        {
        ...
        public static HimImportSummary ImportFrom(LitSettings settings, string path)
        {
